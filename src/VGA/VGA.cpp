...
const Mode VGA::MODE460x480(12, 68, 38, 460, 11, 2, 31, 480, 1, 18124999, 1, 1);
const Mode VGA::MODE460x240(12, 68, 38, 460, 11, 2, 31, 480, 2, 18124999, 1, 1);
...
const Mode VGA::MODE640x480(16, 96, 52, 640, 11, 2, 31, 480, 1, 25175000, 1, 1);
